package org.higherAchievers.lambda.functionalProgramming.functionalInterface;
...
public class FunctionExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(concatFunction.andThen(lowerCaseFunction).apply("PROGRAMMING"));
